...
const isc_info_db_impl_isc_a =            isc_info_db_impl_isc_apl_68K;
const isc_info_db_impl_isc_u =            isc_info_db_impl_isc_vax_ultr;
const isc_info_db_impl_isc_v =            isc_info_db_impl_isc_vms;
const isc_info_db_impl_isc_s =            isc_info_db_impl_isc_sun_68k;
